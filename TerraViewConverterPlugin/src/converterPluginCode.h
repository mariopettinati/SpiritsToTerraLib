...
"converterPlugin",	///< The plugin's name.
"AGRICAB",	///< The plugin's vendor.
"TerraView Converter",	///< The plugin's general description.
PLUGINPARAMETERS_VERSION,	///< The expected plugin parameters version.
"",	///< The plugin vendor's homepage.
"mariopettinati@gmail.com",	///< The plugin vendor's email address.
